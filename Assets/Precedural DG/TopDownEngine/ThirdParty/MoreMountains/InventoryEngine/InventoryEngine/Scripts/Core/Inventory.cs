...
namespace MoreMountains.InventoryEngine
{
    ...
    public class Inventory : MonoBehaviour, MMEventListener<MMInventoryEvent>, MMEventListener<MMGameEvent>
    {
        ...
        //public const string _resourceItemPath = "Assets/Precedural DG/Resources/Itens/PlayerWeapons/Yellow/";
        ...
        public virtual void EquipItem(InventoryItem item, int index, InventorySlot slot = null)
        {
            if (InventoryType == Inventory.InventoryTypes.Main)
            {
                ...
                // we add one to the target equipment inventory and store which Inventory we equipped
                item.UsedInventory = item.TargetEquipmentInventory(PlayerID).name;
        ...
        public virtual void DropItem(InventoryItem item, int index, InventorySlot slot = null)
        {
            ...
            if (this.name == item.TargetEquipmentInventoryName || this.name == item.TargetSecondaryEquipmentInventoryName)
            {
