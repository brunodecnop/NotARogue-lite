...
{	
	...
	public class Teleporter : ButtonActivated 
	{
        ...
        void CameraControll() {
            ...
            if (seletor == Porta.up) Camera.main.transform.position = Camera.main.transform.position + new Vector3(0, 300, 0);
            if (seletor == Porta.down) Camera.main.transform.position = Camera.main.transform.position + new Vector3(0, -300, 0);
            if (seletor == Porta.left) Camera.main.transform.position = Camera.main.transform.position + new Vector3(-608, 0, 0);
            if (seletor == Porta.right) Camera.main.transform.position = Camera.main.transform.position + new Vector3(608, 0, 0);
        }
